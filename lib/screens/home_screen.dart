...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget getWeatherIcon(int? code) {
    ...
    if (code == 800)
      return Image.asset(isNight ? 'assets/12.png' : 'assets/6.png');
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            _buildInfoBlock('Temp Max', 'assets/13.png',
                                "${state.weather.tempMax!.celsius!.round()} °C"),
                            _buildInfoBlock('Temp Min', 'assets/14.png',
  ...
  Widget _buildInfoBlock(String title, String asset, String value) {
    return Row(
      children: [
